...
jsPsych.pluginAPI = (function() {
  ...
  module.autoPreload = function(timeline, callback, images, audio, video, progress_bar) {
    ...
    if(progress_bar){
      var pb_html = "<div id='jspsych-loading-progress-bar-container' style='height: 10px; width: 300px; background-color: #ddd; position: fixed; top: 50%; left: 50%; transform: translate(-50%, -50%);'>";
